...
Software version: `1.4.1`; configuration version: `1.4`.
...
| Encoder | `0x16` | `enc2_closed_loop_enable` | `1` | `bool` | `0` runtime read/write | Output encoder closed-loop enable, `0` off, non-zero on |
...
| Calibration/Test | `0x23` | `backlash_test_enable` | `1` | `bool` | `0` runtime read/write | Runtime backlash-test switch |
